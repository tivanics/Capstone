...
# wrapper function taking the same paramenters as any of the pmatrix functions
# and outputting a ggplotly object prepared for visualization
# by default, the plot generated by preparePlot() is the baseline model for
# the postsurgery state
# TODO helpText for how to use plotly
# TODO: limit results to 2 sigfigs and display reliably
preparePlot <- function(input = "base", state = "Surgery", 
  ...
  if(!by_year) {
    ...
    # TODO: simply serving ggplot w full data and playing w tick marks should be a resolution
    # however, then create a "trancated" boolean in fn input so you can still get that for data table
    # or, just filter it serverside instead
